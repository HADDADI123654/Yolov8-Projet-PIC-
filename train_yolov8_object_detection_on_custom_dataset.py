...
Original file is located at
    https://colab.research.google.com/gist/MRX-Baiz/20ae09d6983fa453585d2fd82475b63d/train-yolov8-object-detection-on-custom-dataset.ipynb
...
rf = Roboflow(api_key="G1O1be8QgtJbF295mkPf")
project = rf.workspace("az-u8zgf").project("suivi-chiros")
...
# Commented out IPython magic to ensure Python compatibility.
# %cd {HOME}
!yolo task=detect mode=predict model={HOME}/runs/detect/train/weights/best.pt conf=0.25 source=/content/video3.MP4
